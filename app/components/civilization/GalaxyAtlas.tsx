...
export default function GalaxyAtlas() {
  return (
     ...
     * IMPORTANT
     *
     * app/home/page.tsx 側ですでに
     * .home-page / .twin-page / data-home-section
     * を管理しているため、
     * GalaxyAtlas自身には home-page を付けない。
     *
     * これによりHOME共通の
     * height / max-height / overflow 制約が
     * Galaxyへ二重適用されることを防ぐ。
     */
    <section className="gx-page">
      ...
      <div className="gx-frame">
        ...
        <div className="gx-map">
          ...
          >
            ...
            <small>
              Symbol / Constitution / Foundation
            </small>
